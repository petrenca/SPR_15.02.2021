...
/*PennController.Sequence( "critical_trials", "preloadCritical","preloadFillers", 
                            "end_post_task2" ,"post-ques",  "final");
...
*/PennController("demographics",
               ...
               .settings.css("font-size", "20px")
               ,
               newText("browser_info", "Bitte beachten Sie, dass dieses Experiment nur mit den Browsern <b>Mozilla Firefox</b> und <b>Google Chrome</b> getestet wurde und nicht auf mobilen Ger&auml;ten funktioniert.<p>")
               .settings.css("font-size", "20px")
               ,
...
PennController.Template( PennController.GetTable("practice.csv") // use subset.csv for celebrity names
                         ...
                         variable => ["practice_trials",
                                      ...
                                      .print("center at 50%","middle at 55%",)
                                             ,
                                             getTimer("delay_practice", 2000)
                                             .start()
                                             .wait()
                                             ,
                                             getKey("q_comp_practice", "FJ")
                                             .settings.log()
                                             .wait()
                                             ,
                                             getText ("ex_ctit_task")
...
PennController.Template(PennController.GetTable( "validation-SPR.csv"),// change this line for the appropriate experimental list  
                        variable => PennController( "final"
                                                    ,
                                                    // F-Version: 
                                                    newText("<p>Vielen Dank f&uuml;r Ihre Teilnahme an unserem Experiment!<p><br><b>Hier ist Ihr Validierungscode: "+variable.val_code+"F.</b><p><br>Bitte geben Sie diesen Code auf der Prolific-Webseite ein, um Ihre Bezahlung zu erhalten.</p>")
                                                    // J-Version: 
